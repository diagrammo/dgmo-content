...
- **Palettes stay intact.** Switching from Nord to Facet adjusts all your colors harmoniously. Direct hex codes would break this.
...
- Every palette (Nord, Catppuccin, Facet, Tokyo Night, etc.) defines its own version of these eleven names
